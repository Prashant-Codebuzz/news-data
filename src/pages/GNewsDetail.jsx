                        ...
                        <div className="row align-items-center">
                            ...
                            <div className="col-lg-6">
                                <div className="right">
                                    ...
                                    <p className='text-dark fw-900 mb-1' style={{ fontSize: '19px' }}>{article?.country[0]}</p>
                                    <p className='text-dark fw-900' style={{ fontSize: '19px' }}>{article?.category[0]}</p>
                                    {/* <div className="sent">
                                            <div>
