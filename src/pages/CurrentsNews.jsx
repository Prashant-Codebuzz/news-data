...
import { getCurrentsNewsService } from '../services/services';
...
const CurrentsNews = () => {
    ...
    const GetNewsData = async () => {
        ...
        try {
            const res = await getCurrentsNewsService(searchQuery);
            console.log(res);
